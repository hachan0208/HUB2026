    ...
    if (err) {
      ...
      fs.readFile(indexPath, 'utf-8', (err, data) => {
        ...
        res.writeHead(200, { 
          ...
          'Content-Security-Policy': "upgrade-insecure-requests; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://www.gstatic.com https://www.googletagmanager.com https://apis.google.com https://*.google.com https://*.run.app https://cdn.jsdelivr.net; connect-src 'self' https://*.run.app https://*.googleapis.com https://*.google-analytics.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; worker-src 'self' blob:; frame-ancestors 'self' https://*.google.com https://localhost.corp.google.com:26001;"
        });
        res.end(data);
      });
      return;
