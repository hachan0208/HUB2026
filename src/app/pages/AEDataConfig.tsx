          ...
          <div className="flex items-center gap-2">
            {onSwitchToFinal && (
              <button
                ...
                className="flex items-center gap-2 px-6 h-11 border border-primary/20 rounded-full bg-primary/5 text-primary font-bold text-[0.6875rem] uppercase tracking-widest hover:bg-primary/10 transition-colors shadow-sm hidden md:flex"
              >
                Go to Final AE
